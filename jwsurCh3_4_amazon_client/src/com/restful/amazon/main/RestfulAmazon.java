package com.restful.amazon.main;
...
import com.restful.amazon.xsd.vo.Item;
import com.restful.amazon.xsd.vo.ItemAttributes;
import com.restful.amazon.xsd.vo.ItemLookupResponse;
import com.restful.amazon.xsd.vo.Items;
...
public class RestfulAmazon {
	...
	public static void main(String[] args) {
		String accessId = KeyHelper.getAccessKeyId();
		String secretKey = KeyHelper.getSecretAccessKey();
		new RestfulAmazon().lookupStuff(accessId, secretKey);
	}
	...
	private void lookupStuff(String accessKeyId, String secretKey) {
		...
		params.put("AssociateTag", "kalinqqcoisa"); // any string should do
