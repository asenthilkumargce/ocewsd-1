 ...
 * generated in the com.ocewsd.binary.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetImageResponse_QNAME = new QName("http://binary.soap.ocewsd.com/", "getImageResponse");
    private final static QName _GetImage_QNAME = new QName("http://binary.soap.ocewsd.com/", "getImage");
    private final static QName _GetImages_QNAME = new QName("http://binary.soap.ocewsd.com/", "getImages");
    private final static QName _GetImagesResponse_QNAME = new QName("http://binary.soap.ocewsd.com/", "getImagesResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ocewsd.binary.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://binary.soap.ocewsd.com/", name = "getImageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://binary.soap.ocewsd.com/", name = "getImage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://binary.soap.ocewsd.com/", name = "getImages")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://binary.soap.ocewsd.com/", name = "getImagesResponse")
