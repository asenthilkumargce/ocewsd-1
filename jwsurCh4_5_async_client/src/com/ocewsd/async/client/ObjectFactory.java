 ...
 * generated in the com.ocewsd.async.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _NextNResponse_QNAME = new QName("http://ocewsd.com/", "nextNResponse");
    private final static QName _Next1_QNAME = new QName("http://ocewsd.com/", "next1");
    private final static QName _NextN_QNAME = new QName("http://ocewsd.com/", "nextN");
    private final static QName _Next1Response_QNAME = new QName("http://ocewsd.com/", "next1Response");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ocewsd.async.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ocewsd.com/", name = "nextNResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ocewsd.com/", name = "next1")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ocewsd.com/", name = "nextN")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ocewsd.com/", name = "next1Response")
