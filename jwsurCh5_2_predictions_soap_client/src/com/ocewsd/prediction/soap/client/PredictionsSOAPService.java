 ...
 * 
 */
@WebServiceClient(name = "PredictionsSOAPService", targetNamespace = "http://soap.prediction.ocewsd.com/", wsdlLocation = "http://localhost:8080/jwsurCh5_1_predctions_soap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PREDICTIONSSOAPSERVICE_QNAME = new QName("http://soap.prediction.ocewsd.com/", "PredictionsSOAPService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jwsurCh5_1_predctions_soap?wsdl");
    ...
    public PredictionsSOAP getPredictionsSOAPPort() {
        return super.getPort(new QName("http://soap.prediction.ocewsd.com/", "PredictionsSOAPPort"), PredictionsSOAP.class);
    }
    ...
    public PredictionsSOAP getPredictionsSOAPPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.prediction.ocewsd.com/", "PredictionsSOAPPort"), PredictionsSOAP.class, features);
    }
